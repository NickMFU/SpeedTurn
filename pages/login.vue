                    ...
                    <v-row>
                      <v-col cols="12" md="6">
                        <v-card-text class="mt-12">
                          ...
                          >Log in to your account so you can continue to website </h6>
                          <v-row align="center" justify="center">
                            <v-col cols="12" sm="8">
                        ...
                        > </v-checkbox>
                            ...
                            <v-btn color="blue" dark block tile to='/home'>Log in</v-btn>
                            </v-col>
                          </v-row>  
                        </v-card-text>
                      </v-col>
                    ...
                    <v-row >
                      ...
                      <v-col cols="12" md="6">
                        ...
                        > </v-checkbox>
                            ...
                            <v-btn color="blue" dark block tile to='/home'>Sign up</v-btn>
                            </v-col>
                          </v-row>  
                        </v-card-text>
                      </v-col>
